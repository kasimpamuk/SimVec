...
model = CLIPModel.from_pretrained("openai/clip-vit-base-patch16", cache_dir="./models/clip-vit-base-patch16")
processor = CLIPProcessor.from_pretrained("openai/clip-vit-base-patch16", cache_dir="./models/clip-vit-base-patch16")
